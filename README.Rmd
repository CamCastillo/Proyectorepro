...
Launch the [`make.R`](https://github.com/CamCastillo/Proyectorepro/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/CamCastillo/Proyectorepro/blob/main/CONTRIBUTING.md).
